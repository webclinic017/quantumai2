...
class StockTrading(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            if self.day >= 8859:
                print(
                    f"warning, self day is out of range, termianl did not work - self.day: {self.day}")
            ...
            try:
                ...
                print(
                    "WARNING: begin_total_asset is zero. Setting portfolio return to zero.")
